...
While PIKE provides a robust measure of broad-scale poaching trends, it may be affected by a number of potential biases related to data quality, variation in carcass detection probabilities, variation in natural mortality rates and other factors (Burn et al. 2011).
