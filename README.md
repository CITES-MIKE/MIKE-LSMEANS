...
PIKE trend analysis is modelled using least-squares means (LSMEANS) approach and is detailed in the R Markdown document: [190815_PIKETrendUsingLSMEANS.Rmd](https://github.com/CITES-MIKE/MIKE-LSMEANS/blob/master/RCODE/190815_PIKETrendUsingLSMEANS.Rmd), under the subdirectory [RCODE](https://github.com/CITES-MIKE/MIKE-LSMEANS/tree/master/RCODE). The R markdown document contains embedded R code for continental-wide  PIKE trend analysis for Africa and Asia plus, at the  subregional level,  for Central, West, East and Southern Africa.  In addition the document has information about the MIKE programme, MIKE data set, and the PIKE indicator.  A sample report generated from the  R markdown document is stored in a  PDF file [190815_PIKETrendUsingLSMEANS.pdf](https://github.com/CITES-MIKE/MIKE-LSMEANS/blob/master/190815_PIKETrendUsingLSMEANS.pdf).
