...
R code to determine PIKE trend based on least-squares means (LSMEANS)  for Africa and its subregions and also for Asia can be found in the in the R Markdown document: *190801_PIKETrendUsingLSMEANS.Rmd*, under the subdirectory *RCODE*. 
